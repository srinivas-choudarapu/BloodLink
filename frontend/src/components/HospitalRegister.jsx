...
const HospitalRegister = ({ onNavigate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post('/auth/register/hospital', registrationData);
      
      setSuccess('Hospital registration successful! You can now login with your credentials.');
    ...
    <div className="register-container">
      <div className="register-card">
        <div className="register-header">
          ...
          <p className="register-subtitle">Join BloodLink as a healthcare partner</p>
        </div>
        ...
        <form className="register-form" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="register-button hospital-register-button"
            disabled={isLoading}
          >
